...
//         <div
//           key={item.id}
//           className="bg-white rounded-2xl shadow-lg overflow-hidden border border-[rgba(0,0,0,0.1)] max-w-xs"
//         >
//           <div className="w-full">
//             <Image
//               src={item.image}
//               alt={item.title}
//               width={500} // natural image width
//               height={300} // natural image height

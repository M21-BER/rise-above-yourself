      ...
      <div className="relative z-10 w-full h-full">
        <div className="container mx-auto h-full flex flex-col justify-end sm:justify-start">
          <div
            ...
            `}
          >
            <h2 className="text-base font-allerta_stencil uppercase text-center sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold mb-3">
              Rise Above Yourself
            </h2>
            ...
            <p className="text-sm sm:text-sm md:text-base lg:text-lg  2xl:text-xl text-[rgb(51,51,51)] mb-2">
              ...
              <strong className="text-red-600 italic font-bold">
                {" "}
                It's about rising above who you were yesterday.
              </strong>
            </p>

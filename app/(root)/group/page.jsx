      ...
      <div className="flex flex-col lg:flex-row items-stretch w-full">
        ...
        <div className="flex-1 flex flex-col justify-center p-6 sm:p-8 lg:p-12">
          ...
          <ul className="mt-4 space-y-2 text-sm sm:text-base text-black/80 list-disc list-inside">
            ...
            <li>Support weight loss goals</li>
            <li>Boost endurance and energy</li>
            <li>Train in a supportive, motivating environment</li>
          </ul>
        ...
        <div className="flex-1 relative min-h-[250px] sm:min-h-[300px] lg:min-h-full">
          <Image
            src="/images/asset1.jpg" // replace with your image path
